        ...
        >
          <div className="flex h-16 shrink-0 items-center justify-between border-b border-border/[var(--border-alpha)] px-6">
            <div className="flex items-baseline gap-2">
              <SheetTitle asChild>
                <h2 className="font-display text-h3 font-medium text-fg">Your cart</h2>
              </SheetTitle>
              {lines.length > 0 && (
                ...
                {notes && (
                  <div className="mt-4 flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      maxLength={200}
                      placeholder={
                        notes.placeholder ?? 'Anything we should know about your order?'
                      }
                      value={notes.value}
          ...
          {lines.length > 0 && (
            <div className="shrink-0 border-t border-border/[var(--border-alpha)] bg-surface-2 p-6">
              ...
              <p className="mt-3 text-center text-[12px] text-fg-subtle">
                Free baklava on first order — code at checkout.
              </p>
            </div>
          )}
        </SheetContent>
