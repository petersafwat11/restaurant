...
**Plan first.** For any non-trivial task (more than ~30 lines or touching more than one file), write a short plan to `.Codex/plans/<task-slug>.md` and ask for approval before implementing.
