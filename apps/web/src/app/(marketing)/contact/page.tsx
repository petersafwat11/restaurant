      ...
      <section className="bg-bg pt-section-y-mobile sm:pt-section-y">
        <Container>
          <SectionHeader
            eyebrow="Contact"
            title="Get in touch."
            description="Questions about an order, an event, or a delivery zone — we read everything."
            align="center"
          />
        </Container>
      </section>
        ...
        <Container>
          <div className="mx-auto grid max-w-[960px] grid-cols-1 gap-12 lg:grid-cols-[2fr_3fr]">
            <aside className="flex flex-col gap-4 rounded-card border border-border/[var(--border-strong-alpha)] bg-surface-2 p-6">
              <h3 className="font-display text-h3 font-semibold text-fg">Find us</h3>
              <ul className="flex flex-col gap-3">
                <li className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col leading-snug">
                    ...
                    <span className="text-body font-medium text-fg">{mockLocation.address1}</span>
                    <span className="text-small text-fg-muted">{mockLocation.address2}</span>
                  </div>
                </li>
                <li>
                  <Link
            ...
            {sent ? (
              <div className="flex flex-col items-center gap-3 rounded-card border border-positive/20 bg-positive/10 p-8 text-center">
                ...
                <h3 className="font-display text-h3 text-fg">Message sent</h3>
                <p className="text-small text-fg-muted">
                  Thanks — we'll reply within a day or two.
                </p>
                <button
                  type="button"
