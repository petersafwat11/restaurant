...
export class MenuController {
  ...
  @Public()
  @Get('menu/categories/:categorySlug/items/:itemSlug')
  getItem(
  ...
  @AuditAction('menu:category:write', 'menu_category')
  createCategory(
  ...
  updateCategory(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(UpdateMenuCategorySchema)) dto: UpdateMenuCategoryDto,
  ) {
  ...
  @HttpCode(200)
  @Permissions('menu:write')
  @AuditAction('menu:category:delete', 'menu_category')
  async deleteCategory(@Param('id') id: string) {
    const removed = await this.menu.deleteCategory(id);
  ...
  @HttpCode(200)
  @Permissions('menu:write')
  async reorderCategories(@Body(new ZodValidationPipe(ReorderSchema)) dto: ReorderDto) {
  ...
  @Post('menu/items')
  @Permissions('menu:write')
  @AuditAction('menu:item:write', 'menu_item')
  createItem(@Body(new ZodValidationPipe(CreateMenuItemSchema)) dto: CreateMenuItemDto) {
  ...
  @HttpCode(200)
  @Permissions('menu:write')
  @AuditAction('menu:item:delete', 'menu_item')
  async deleteItem(@Param('id') id: string) {
    const removed = await this.menu.deleteItem(id);
    return { success: true as const, ...removed };
  }
  ...
  setItemAvailability(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(SetItemAvailabilitySchema)) dto: SetItemAvailabilityDto,
  ) {
  ...
  @HttpCode(200)
  @Permissions('menu:write')
  async reorderItems(@Body(new ZodValidationPipe(ReorderItemsSchema)) dto: ReorderItemsDto) {
  ...
  addImage(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(AddMenuItemImageSchema)) dto: AddMenuItemImageDto,
  ) {
  ...
  createModifierGroup(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(CreateModifierGroupSchema)) dto: CreateModifierGroupDto,
  ) {
  ...
  createModifierOption(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(CreateModifierOptionSchema)) dto: CreateModifierOptionDto,
  ) {
  ...
  updateModifierOption(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(UpdateModifierOptionSchema)) dto: UpdateModifierOptionDto,
  ) {
