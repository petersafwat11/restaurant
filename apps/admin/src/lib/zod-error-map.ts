...
/**
 * Maps Zod issues to translated messages from `validation.*` keys. Mirrors
 * `apps/web/src/lib/zod-error-map.ts` and the API's ZodValidationPipe — all
 * three consult `packages/i18n/messages/{locale}/validation.json`.
 */
