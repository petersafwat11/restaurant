 ...
 * Dashboard shell.
 *
 * - Sidebar collapses below 1280px (admin density target — README §4).
 * - Topbar reads its config from PageHeaderContext, so each page sets its
 *   own title and (optionally) a date range.
 * - Auth gate: redirects to /login once the auth store finishes hydrating
