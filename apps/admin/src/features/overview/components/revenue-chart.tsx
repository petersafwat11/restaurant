  ...
  return (
    <div className="flex h-[360px] flex-col rounded-card border-hairline bg-surface p-4">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="text-h2-admin text-fg">Revenue</h2>
        <div role="group" aria-label="Series" className="flex items-center gap-1 text-xs">
          <button
            type="button"
            aria-pressed
          ...
          >
            <span className="h-2 w-2 rounded-full bg-chart-2" /> Orders
          </button>
        </div>
      </div>
